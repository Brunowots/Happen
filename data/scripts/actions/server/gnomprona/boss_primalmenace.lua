local config = {
  eventBoss = boss_primalmenace, -- Nome do evento
  bossAction = 63019, -- Action id que fica na alavanca
  storageQuest = 30063, -- Storage para tempo da quest
  ...
  exit_player = Position(33556, 32748, 14) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33548, 32752, 14), toPos = Position(33557, 32765, 15)},
    [2] = {fromPos = Position(33549, 32752, 14), toPos = Position(33557, 32765, 15)},
    [3] = {fromPos = Position(33550, 32752, 14), toPos = Position(33557, 32765, 15)},
    [4] = {fromPos = Position(33551, 32752, 14), toPos = Position(33557, 32765, 15)},
	[5] = {fromPos = Position(33552, 32752, 14), toPos = Position(33557, 32765, 15)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33557, 32753, 15), name = "The Primal Menace"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33547, 32749, 15), toPos = Position(33568, 32768, 15)} -- Cordenada Nort Esquerda ~ Sul Direita
