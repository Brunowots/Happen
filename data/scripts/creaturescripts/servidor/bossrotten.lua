local config = {
	name_Event = BossRotten,
	evento_monstro = "bossrotten",
	Storage = 331802,
	NorteEsquerda = Position(33734, 31590, 14),
	SulDireita = Position(33753, 31609, 14),
	TextoAoMatarBoss = "Agora voce tem acesso a sala do terceiro boss"
}
