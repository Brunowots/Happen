local config = {
  eventBoss = boss_malofur, -- Nome do evento
  bossAction = 63036, -- Action id que fica na alavanca
...
local player_positions = { 
    [1] = {fromPos = Position(32208, 32021, 13), toPos = Position(32263, 32048, 14)},
    [2] = {fromPos = Position(32208, 32022, 13), toPos = Position(32263, 32048, 14)},
    [3] = {fromPos = Position(32208, 32023, 13), toPos = Position(32263, 32048, 14)},
    [4] = {fromPos = Position(32208, 32024, 13), toPos = Position(32263, 32048, 14)},
	[5] = {fromPos = Position(32208, 32025, 13), toPos = Position(32263, 32048, 14)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32240, 32043, 14), name = "Malofur Mangrinder"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(32237, 32040, 14), toPos = Position(32267, 32056, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
