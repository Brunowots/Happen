local config = {
  eventBoss = boss_jaul, -- Nome do evento
  bossAction = 63045, -- Action id que fica na alavanca
  ...
  exit_player = Position(33558, 31283, 11) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33545, 31231, 11), toPos = Position(33536, 31263, 11)},
    [2] = {fromPos = Position(33546, 31231, 11), toPos = Position(33536, 31263, 11)},
    [3] = {fromPos = Position(33545, 31230, 11), toPos = Position(33536, 31263, 11)},
    [4] = {fromPos = Position(33546, 31230, 11), toPos = Position(33536, 31263, 11)},
	[5] = {fromPos = Position(33545, 31229, 11), toPos = Position(33536, 31263, 11)},
	[6] = {fromPos = Position(33546, 31229, 11), toPos = Position(33536, 31263, 11)},
	[7] = {fromPos = Position(33545, 31232, 11), toPos = Position(33536, 31263, 11)},
	[8] = {fromPos = Position(33546, 31232, 11), toPos = Position(33536, 31263, 11)},
	[9] = {fromPos = Position(33545, 31233, 11), toPos = Position(33536, 31263, 11)},
	[10] = {fromPos = Position(33546, 31233, 11), toPos = Position(33536, 31263, 11)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33546, 31276, 11), name = "Jaul"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33529, 31259, 11), toPos = Position(33554, 31279, 11)} -- Cordenada Nort Esquerda ~ Sul Direita
