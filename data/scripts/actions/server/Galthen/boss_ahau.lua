local config = {
  ...
  bossAction = 63050, -- Action id que fica na alavanca
  storageQuest = 30083, -- Storage para tempo da quest
  ...
  level_req = 150, -- Level Requerido
  min_players = 1, -- Minimo de Jogadores
  exit_player = Position(34076, 31801, 9) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(34075, 31791, 9), toPos = Position(34071, 31774, 9)},
    [2] = {fromPos = Position(34074, 31791, 9), toPos = Position(34071, 31774, 9)},
    [3] = {fromPos = Position(34073, 31791, 9), toPos = Position(34071, 31774, 9)},
    [4] = {fromPos = Position(34072, 31791, 9), toPos = Position(34071, 31774, 9)},
	[5] = {fromPos = Position(34071, 31791, 9), toPos = Position(34071, 31774, 9)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(34071, 31770, 9), name = "Ahau"},	-- Posição do 'BOSS'
	[2] = {pos = Position(34077, 31770, 9), name = "Cursed Ape"},
	[3] = {pos = Position(34066, 31770, 9), name = "Cursed Ape"},
	[4] = {pos = Position(34071, 31772, 9), name = "Cursed Ape"}
	
}

-- Area da Quest
local quest_range = {fromPos = Position(34060, 31763, 9), toPos = Position(34083, 31780, 9)} -- Cordenada Nort Esquerda ~ Sul Direita
