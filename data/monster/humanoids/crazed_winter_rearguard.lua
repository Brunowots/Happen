...
monster.loot = {
	...
	{name = "life crystal", chance = 10550},
	{name = "dream essence egg", chance = 6350},
	{name = "elven astral observer", chance = 14600},
	{name = "glacier mask", chance = 3850},
	{name = "moonlight rod", chance = 11250},
	{name = "small enchanted sapphire", chance = 16850, maxCount = 7},
	{name = "northwind rod", chance = 10000},
	{name = "glacier amulet", chance = 8000},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = -200, maxDamage = -500, radius = 3, effect = CONST_ME_ICEAREA, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = -250, maxDamage = -400, range = 7, shootEffect = CONST_ANI_ICE, target = false}
}
