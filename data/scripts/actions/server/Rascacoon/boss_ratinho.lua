local config = {
  eventBoss = boss_ratinho, -- Nome do evento
  bossAction = 63029, -- Action id que fica na alavanca
  storageQuest = 30073, -- Storage para tempo da quest
  ...
  exit_player = Position(33896, 31391, 15) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33893, 31388, 15), toPos = Position(33901, 31373, 15)},
    [2] = {fromPos = Position(33894, 31388, 15), toPos = Position(33901, 31373, 15)},
    [3] = {fromPos = Position(33895, 31388, 15), toPos = Position(33901, 31373, 15)},
    [4] = {fromPos = Position(33896, 31388, 15), toPos = Position(33901, 31373, 15)},
	[5] = {fromPos = Position(33897, 31388, 15), toPos = Position(33901, 31373, 15)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33904, 31348, 15), name = "Ratmiral Blackwhiskers"} -- Posi??o do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33886, 31343, 15), toPos = Position(33918, 31377, 15)} -- Cordenada Nort Esquerda ~ Sul Direita
