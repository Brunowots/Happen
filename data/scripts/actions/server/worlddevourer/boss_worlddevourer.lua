local config = {
  eventBoss = boss_worlddevourer, -- Nome do evento
  bossAction = 63048, -- Action id que fica na alavanca
  storageQuest = 30081, -- Storage para tempo da quest
  duration = 15, -- Dura??o em Minutos para matar o bos depois disso vc sera teletransportado para fora da sala
  TempoQuestHoras = 144000, -- 72000, -- Tempo para matar o boss novamente || 1 hora = 3600 sendo - [36000 = 10 horas] ~ [72000 = 20 horas]
  level_req = 400, -- Level Requerido
  min_players = 1, -- Minimo de Jogadores
  exit_player = Position(32213, 31375, 14) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(32272, 31374, 14), toPos = Position(32272, 31357, 14)},
    [2] = {fromPos = Position(32271, 31374, 14), toPos = Position(32272, 31357, 14)},
    [3] = {fromPos = Position(32273, 31374, 14), toPos = Position(32272, 31357, 14)},
    [4] = {fromPos = Position(32271, 31375, 14), toPos = Position(32272, 31357, 14)},
	[5] = {fromPos = Position(32272, 31375, 14), toPos = Position(32272, 31357, 14)},
	[6] = {fromPos = Position(32273, 31375, 14), toPos = Position(32272, 31357, 14)},
	[7] = {fromPos = Position(32271, 31376, 14), toPos = Position(32272, 31357, 14)},
	[8] = {fromPos = Position(32272, 31376, 14), toPos = Position(32272, 31357, 14)},
	[9] = {fromPos = Position(32273, 31376, 14), toPos = Position(32272, 31357, 14)},
	[10] = {fromPos = Position(32271, 31377, 14), toPos = Position(32272, 31357, 14)},
	[11] = {fromPos = Position(32272, 31377, 14), toPos = Position(32272, 31357, 14)},
	[12] = {fromPos = Position(32273, 31377, 14), toPos = Position(32272, 31357, 14)},
	[13] = {fromPos = Position(32271, 31378, 14), toPos = Position(32272, 31357, 14)},
	[14] = {fromPos = Position(32272, 31378, 14), toPos = Position(32272, 31357, 14)},
	[15] = {fromPos = Position(32273, 31378, 14), toPos = Position(32272, 31357, 14)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32271, 31346, 14), name = "World Devourer"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(32260, 31337, 14), toPos = Position(32281, 31359, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
