local config = {
  eventBoss = boss_Gorzindel, -- Nome do evento
  bossAction = 63028, -- Action id que fica na alavanca
  storageQuest = 30072, -- Storage para tempo da quest
  ...
  exit_player = Position(32747, 32745, 10) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(32747, 32749, 10), toPos = Position(32687, 32724, 10)},
    [2] = {fromPos = Position(32748, 32749, 10), toPos = Position(32687, 32724, 10)},
    [3] = {fromPos = Position(32749, 32749, 10), toPos = Position(32687, 32724, 10)},
    [4] = {fromPos = Position(32750, 32749, 10), toPos = Position(32687, 32724, 10)},
	[5] = {fromPos = Position(32751, 32749, 10), toPos = Position(32687, 32724, 10)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32687, 32715, 10), name = "Gorzindel"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(32716, 32712, 10), toPos = Position(32733, 32729, 10)} -- Cordenada Nort Esquerda ~ Sul Direita
