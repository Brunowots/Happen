...
monster.loot = {
	...
	{id = 6558, chance = 14000, maxCount = 3}, -- flask of demonic blood
	{id = 9058, chance = 7000, maxCount = 2}, -- gold ingot
	{id = 238, chance = 19600, maxCount = 2}, -- great mana potion
	{id = 7642, chance = 13000, maxCount = 2}, -- great spirit potion
	{id = 3033, chance = 8000, maxCount = 5}, -- small amethyst
	{id = 3028, chance = 8000, maxCount = 5}, -- small diamond
	...
	{id = 7643, chance = 53000, maxCount = 2}, -- ultimate health potion
	{id = 3019, chance = 2000}, -- demonbone amulet
	{id = 6499, chance = 7000}, -- demonic essence
	...
	{id = 3414, chance = 950}, -- mastermind shield
	{id = 22729, chance = 2800}, -- pair of hellflayer horns
	{id = 3039, chance = 7000}, -- red gem
	{id = 22866, chance = 1080}, -- rift bow
	{id = 22867, chance = 1080}, -- rift crossbow
	{id = 5741, chance = 1300}, -- skull helmet
	{id = 22727, chance = 1000}, -- rift lance
	{id = 7413, chance = 5000}, -- titan axe
	{id = 3360, chance = 3000}, -- golden armor
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -270, maxDamage = -500, range = 7, shootEffect = CONST_ANI_POISON, target = false},
	{name ="renegade knight", interval = 2000, chance = 20, target = false},
	{name ="choking fear drown", interval = 2000, chance = 20, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -550, maxDamage = -1000, radius = 4, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -300, maxDamage = -800, radius = 1, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_SLEEP, target = true}
}
