...
monster.loot = {
	...
	{name = "sacred tree amulet", chance = 18500},
	{name = "crystalline armor", chance = 4500},
	{name = "rubber cap", chance = 13500},
	{name = "fur armor", chance = 12500},
	{id = 34109, chance = 50} -- bag you desire
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -490, maxDamage = -900},
