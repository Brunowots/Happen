local config = {
  eventBoss = boss_izcandar, -- Nome do evento
  bossAction = 63035, -- Action id que fica na alavanca
...
local player_positions = { 
    [1] = {fromPos = Position(32206, 32021, 13), toPos = Position(32189, 32048, 14)},
    [2] = {fromPos = Position(32206, 32022, 13), toPos = Position(32189, 32048, 14)},
    [3] = {fromPos = Position(32206, 32023, 13), toPos = Position(32189, 32048, 14)},
    [4] = {fromPos = Position(32206, 32024, 13), toPos = Position(32189, 32048, 14)},
	[5] = {fromPos = Position(32206, 32025, 13), toPos = Position(32189, 32048, 14)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32168, 32043, 14), name = "Izcandar the Banished"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(32164, 32040, 14), toPos = Position(32194, 32057, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
