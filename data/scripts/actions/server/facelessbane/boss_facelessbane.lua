local config = {
  eventBoss = boss_facelessbane, -- Nome do evento
  bossAction = 63049, -- Action id que fica na alavanca
  storageQuest = 30082, -- Storage para tempo da quest
  ...
  level_req = 250, -- Level Requerido
  min_players = 1, -- Minimo de Jogadores
  exit_player = Position(33618, 32523, 15) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33638, 32562, 13), toPos = Position(33617, 32567, 13)},
    [2] = {fromPos = Position(33639, 32562, 13), toPos = Position(33617, 32567, 13)},
    [3] = {fromPos = Position(33640, 32562, 13), toPos = Position(33617, 32567, 13)},
    [4] = {fromPos = Position(33641, 32562, 13), toPos = Position(33617, 32567, 13)},
	[5] = {fromPos = Position(33642, 32562, 13), toPos = Position(33617, 32567, 13)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33617, 32561, 13), name = "Faceless Bane"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33608, 32554, 13), toPos = Position(33628, 32571, 13)} -- Cordenada Nort Esquerda ~ Sul Direita
