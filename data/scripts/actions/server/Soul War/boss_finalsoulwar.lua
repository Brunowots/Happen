local config = {
  eventBoss = boss_finalsoulwar, -- Nome do evento
  bossAction = 63005, -- Action id que fica na alavanca
  storageQuest = 30055, -- Storage para tempo da quest
  ...
  exit_player = Position(33681, 31630, 14) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33676, 31634, 14), toPos = Position(33710, 31641, 14)},
    [2] = {fromPos = Position(33677, 31634, 14), toPos = Position(33710, 31641, 14)},
    [3] = {fromPos = Position(33678, 31634, 14), toPos = Position(33710, 31641, 14)},
    [4] = {fromPos = Position(33679, 31634, 14), toPos = Position(33710, 31641, 14)},
	[5] = {fromPos = Position(33680, 31634, 14), toPos = Position(33710, 31641, 14)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33710, 31630, 14), name = "Goshnar's Megalomania"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33701, 31625, 14), toPos = Position(33720, 31644, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
