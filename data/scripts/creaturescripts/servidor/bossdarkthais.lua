local config = {
	name_Event = Bossdarkthais,
	evento_monstro = "bossdarkthais",
	Storage = 331805,
	NorteEsquerda = Position(33737, 31657, 14),
	SulDireita = Position(33757, 31675, 14),
	TextoAoMatarBoss = "Agora voce tem acesso a sala do final boss"
}
