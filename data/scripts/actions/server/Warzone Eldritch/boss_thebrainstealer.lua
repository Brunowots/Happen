local config = {
  eventBoss = boss_thebrainstealer, -- Nome do evento
  bossAction = 63011, -- Action id que fica na alavanca
  storageQuest = 30061, -- Storage para tempo da quest
  ...
  exit_player = Position(32537, 31119, 15) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(32530, 31122, 15), toPos = Position(32498, 31130, 15)},
    [2] = {fromPos = Position(32531, 31122, 15), toPos = Position(32498, 31130, 15)},
    [3] = {fromPos = Position(32532, 31122, 15), toPos = Position(32498, 31130, 15)},
    [4] = {fromPos = Position(32533, 31122, 15), toPos = Position(32498, 31130, 15)},
	[5] = {fromPos = Position(32534, 31122, 15), toPos = Position(32498, 31130, 15)},
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32498, 31121, 15), name = "The Brainstealer"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(32490, 31116, 15), toPos = Position(32508, 31134, 15)} -- Cordenada Nort Esquerda ~ Sul Direita
