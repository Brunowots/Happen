...
monster.loot = {
	...
	{id = 6299, chance = 12008}, -- death ring
	{name = "demonic essence", chance = 18520},
	{id = 6555, chance = 23400, maxCount = 3}, -- death ring
	{name = "assassin star", chance = 12222, maxCount = 5},
	{name = "vile axe", chance = 4800},
	{name = "butcher's axe", chance = 8500},
	{name = "great mana potion", chance = 14830, maxCount = 2},
	{name = "great health potion", chance = 10000, maxCount = 2},
	{name = "gold ingot", chance = 13140}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -200, maxDamage = -600},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -300, maxDamage = -781, range = 7, shootEffect = CONST_ANI_THROWINGKNIFE, target = false},
