local config = {
  eventBoss = boss_nightmarebeast, -- Nome do evento
  bossAction = 63012, -- Action id que fica na alavanca
  storageQuest = 30062, -- Storage para tempo da quest
  ...
  exit_player = Position(32211, 32084, 15) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(32212, 32070, 15), toPos = Position(32208, 32052, 15)},
    [2] = {fromPos = Position(32211, 32070, 15), toPos = Position(32208, 32052, 15)},
    [3] = {fromPos = Position(32213, 32070, 15), toPos = Position(32208, 32052, 15)},
    [4] = {fromPos = Position(32214, 32070, 15), toPos = Position(32208, 32052, 15)},
	[5] = {fromPos = Position(32210, 32070, 15), toPos = Position(32208, 32052, 15)},
	[6] = {fromPos = Position(32210, 32071, 15), toPos = Position(32208, 32052, 15)},
	[7] = {fromPos = Position(32211, 32071, 15), toPos = Position(32208, 32052, 15)},
	[8] = {fromPos = Position(32212, 32071, 15), toPos = Position(32208, 32052, 15)},
	[9] = {fromPos = Position(32213, 32071, 15), toPos = Position(32208, 32052, 15)},
	[10] = {fromPos = Position(32214, 32071, 15), toPos = Position(32208, 32052, 15)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32208, 32043, 15), name = "The Nightmare Beast"} -- Posição do 'BOSS'
}

-- Area da Quest, Cordenada Nort Esquerda ~ Sul Direita
local quest_range = {fromPos = Position(32194, 32035, 15), toPos = Position(32221, 32057, 15)} -- Cordenada Nort Esquerda ~ Sul Direita
