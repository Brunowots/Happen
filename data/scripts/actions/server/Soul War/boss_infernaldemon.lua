local config = {
  eventBoss = boss_infernal, -- Nome do evento
  bossAction = 63001, -- Action id que fica na alavanca
  storageQuest = 30051, -- Storage para tempo da quest
  ...
  exit_player = Position(33685, 31595, 14) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33679, 31599, 14), toPos = Position(33709, 31605, 14)},
    [2] = {fromPos = Position(33680, 31599, 14), toPos = Position(33709, 31605, 14)},
    [3] = {fromPos = Position(33681, 31599, 14), toPos = Position(33709, 31605, 14)},
    [4] = {fromPos = Position(33682, 31599, 14), toPos = Position(33709, 31605, 14)},
	[5] = {fromPos = Position(33683, 31599, 14), toPos = Position(33709, 31605, 14)},
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33709, 31594, 14), name = "Goshnar's Malice"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33698, 31590, 14), toPos = Position(33720, 31609, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
