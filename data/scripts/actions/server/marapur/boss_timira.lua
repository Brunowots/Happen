local config = {
  eventBoss = boss_timira, -- Nome do evento
  bossAction = 63032, -- Action id que fica na alavanca
  storageQuest = 30078, -- Storage para tempo da quest
  ...
  exit_player = Position(33807, 32697, 8) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33809, 32702, 8), toPos = Position(33808, 32705, 9)},
    [2] = {fromPos = Position(33808, 32702, 8), toPos = Position(33808, 32705, 9)},
    [3] = {fromPos = Position(33807, 32702, 8), toPos = Position(33808, 32705, 9)},
    [4] = {fromPos = Position(33806, 32702, 8), toPos = Position(33808, 32705, 9)},
	[5] = {fromPos = Position(33805, 32702, 8), toPos = Position(33808, 32705, 9)},
}

-- Position dos bosses e seu nome
local monsters = {
	[1] = {pos = Position(33821, 32703, 9), name = "Timira The Many-Headed"} -- Mude o nome e a posi??o do boss
}

-- Area da Quest, Cordenada Nort Esquerda ~ Sul Direita
local quest_range = {fromPos = Position(33807, 32697, 9), toPos = Position(33823, 32712, 9)} -- Cordenada Nort Esquerda ~ Sul Direita
