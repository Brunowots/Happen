local config = {
  eventBoss = boss_tanjis, -- Nome do evento
  bossAction = 63046, -- Action id que fica na alavanca
  storageQuest = 30080, -- Storage para tempo da quest
  ...
  level_req = 200, -- Level Requerido
  min_players = 1, -- Minimo de Jogadores
  exit_player = Position(33647, 31261, 11) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33555, 31231, 11), toPos = Position(33636, 31237, 11)},
    [2] = {fromPos = Position(33556, 31231, 11), toPos = Position(33636, 31237, 11)},
    [3] = {fromPos = Position(33555, 31230, 11), toPos = Position(33636, 31237, 11)},
    [4] = {fromPos = Position(33556, 31230, 11), toPos = Position(33636, 31237, 11)},
	[5] = {fromPos = Position(33555, 31229, 11), toPos = Position(33636, 31237, 11)},
	[6] = {fromPos = Position(33556, 31229, 11), toPos = Position(33636, 31237, 11)},
	[7] = {fromPos = Position(33555, 31232, 11), toPos = Position(33636, 31237, 11)},
	[8] = {fromPos = Position(33556, 31232, 11), toPos = Position(33636, 31237, 11)},
	[9] = {fromPos = Position(33555, 31233, 11), toPos = Position(33636, 31237, 11)},
	[10] = {fromPos = Position(33556, 31233, 11), toPos = Position(33636, 31237, 11)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33649, 31251, 11), name = "Tanjis"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33635, 31231, 11), toPos = Position(33654, 31256, 11)} -- Cordenada Nort Esquerda ~ Sul Direita
