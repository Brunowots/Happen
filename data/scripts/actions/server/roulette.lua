local config = {
    ...
    rouletteOptions = {
        ...
        rouletteStorage = 88571 
    },
    prizePool = {
        {itemId = 43885, count = {1, 1},   chance = 6500},
        {itemId = 43877, count = {1, 1},    chance = 9000 },
        {itemId = 43882, count = {1, 1},    chance = 8500 },
        {itemId = 43879, count = {1, 1},    chance = 10000 },
        {itemId = 43870, count = {1, 1},   chance = 10000 },
        {itemId = 43868, count = {1, 1}, chance = 5000 },
        {itemId = 43866, count = {1, 1},    chance = 5100 }

    
    },
    roulettePositions = {
        Position(32375, 32236, 7),
        Position(32376, 32236, 7),
        Position(32377, 32236, 7),
        Position(32378, 32236, 7),
        Position(32379, 32236, 7),
        Position(32380, 32236, 7),
        Position(32381, 32236, 7),
    }
}
