...
HouseDummies = {28559, 28560, 28561, 28562, 28563, 28564, 22330, 22333}
...
function ExerciseEvent(playerId, tilePosition, weaponId, dummyId)
	...
	if bonusDummy then bonusDummy = 1.2 else bonusDummy = 1 end
	if player:getItemById() == 22330 or player: getItemById() == 22333 then
