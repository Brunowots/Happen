local config = {
  eventBoss = boss_lokathmor, -- Nome do evento
  bossAction = 63027, -- Action id que fica na alavanca
  storageQuest = 30071, -- Storage para tempo da quest
  ...
  exit_player = Position(32721, 32745, 10) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(32721, 32749, 10), toPos = Position(32750, 32681, 10)},
    [2] = {fromPos = Position(32722, 32749, 10), toPos = Position(32750, 32681, 10)},
    [3] = {fromPos = Position(32723, 32749, 10), toPos = Position(32750, 32681, 10)},
    [4] = {fromPos = Position(32724, 32749, 10), toPos = Position(32750, 32681, 10)},
	[5] = {fromPos = Position(32725, 32749, 10), toPos = Position(32750, 32681, 10)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32751, 32689, 10), name = "Lokathmor"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(32743, 32681, 10), toPos = Position(32759, 32697, 10)} -- Cordenada Nort Esquerda ~ Sul Direita
