local config = {
  eventBoss = boss_darkthais, -- Nome do evento
  bossAction = 63000, -- Action id que fica na alavanca
  storageQuest = 30050, -- Storage para tempo da quest
  ...
  exit_player = Position(33782, 31661, 14) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33776, 31665, 14), toPos = Position(33747, 31671, 14)},
    [2] = {fromPos = Position(33777, 31665, 14), toPos = Position(33747, 31671, 14)},
    [3] = {fromPos = Position(33778, 31665, 14), toPos = Position(33747, 31671, 14)},
    [4] = {fromPos = Position(33779, 31665, 14), toPos = Position(33747, 31671, 14)},
	[5] = {fromPos = Position(33780, 31665, 14), toPos = Position(33747, 31671, 14)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33742, 31660, 14), name = "Goshnar's Greed"} -- Posi??o do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33737, 31657, 14), toPos = Position(33757, 31675, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
