local config = {
  eventBoss = boss_Ghulosh, -- Nome do evento
  bossAction = 63033, -- Action id que fica na alavanca
  storageQuest = 30076, -- Storage para tempo da quest
  ...
  exit_player = Position(32747, 32769, 10) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(32747, 32773, 10), toPos = Position(32755, 32727, 10)},
    [2] = {fromPos = Position(32748, 32773, 10), toPos = Position(32755, 32727, 10)},
    [3] = {fromPos = Position(32749, 32773, 10), toPos = Position(32755, 32727, 10)},
    [4] = {fromPos = Position(32750, 32773, 10), toPos = Position(32755, 32727, 10)},
	[5] = {fromPos = Position(32751, 32773, 10), toPos = Position(32755, 32727, 10)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32756, 32717, 10), name = "Ghulosh"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(32748, 32713, 10), toPos = Position(32764, 32730, 10)} -- Cordenada Nort Esquerda ~ Sul Direita
