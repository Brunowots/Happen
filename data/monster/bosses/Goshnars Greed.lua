...
monster.loot = {
	...
	{name = "Spectral Saddle",  maxCount = 1, chance = 100},
...
monster.attacks = {
	{name="melee" ,interval="2000" ,minDamage="-800" ,maxDamage="-3050"},	
	{name ="combat", interval = 2000, chance = 80, type = COMBAT_DEATHDAMAGE, minDamage = -350, maxDamage = -1220, length = 8, spread = 3, target = false},
	...
	{name ="combat", interval = 2000, chance = 50, type = COMBAT_DEATHDAMAGE, minDamage = -900, maxDamage = -2000, radius = 4, target = false},
	{name ="combat", interval = 2000, chance = 50, type = COMBAT_DEATHDAMAGE, minDamage = -120, maxDamage = -1800, range = 7, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = true},
	{name ="combat", interval = 6000, chance = 80, type = COMBAT_HOLYDAMAGE, minDamage = -400, maxDamage = -2050, length = 8, spread = 3, effect = CONST_ME_HOLYAREA, target = false},
