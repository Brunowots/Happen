local config = {
  eventBoss = boss_cloak, -- Nome do evento
  bossAction = 63004, -- Action id que fica na alavanca
  storageQuest = 30054, -- Storage para tempo da quest
  ...
  exit_player = Position(33856, 31866, 7) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33854, 31854, 6), toPos = Position(33855, 31873, 7)},
    [2] = {fromPos = Position(33855, 31854, 6), toPos = Position(33855, 31873, 7)},
    [3] = {fromPos = Position(33856, 31854, 6), toPos = Position(33855, 31873, 7)},
    [4] = {fromPos = Position(33857, 31854, 6), toPos = Position(33855, 31873, 7)},
	[5] = {fromPos = Position(33858, 31854, 6), toPos = Position(33855, 31873, 7)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33852, 31860, 7), name = "Goshnar's Cruelty"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33846, 31857, 7), toPos = Position(33865, 31875, 7)} -- Cordenada Nort Esquerda ~ Sul Direita
