local config = {
  eventBoss = boss_alptramun, -- Nome do evento
  bossAction = 63037, -- Action id que fica na alavanca
  storageQuest = 30079, -- Storage para tempo da quest
  ...
  exit_player = Position(32208, 32059, 13) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(32212, 32021, 13), toPos = Position(32226, 32048, 14)},
    [2] = {fromPos = Position(32212, 32022, 13), toPos = Position(32226, 32048, 14)},
    [3] = {fromPos = Position(32212, 32023, 13), toPos = Position(32226, 32048, 14)},
    [4] = {fromPos = Position(32212, 32024, 13), toPos = Position(32226, 32048, 14)},
	[5] = {fromPos = Position(32212, 32025, 13), toPos = Position(32226, 32048, 14)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32204, 32043, 14), name = "Alptramun"} -- Posição do 'BOSS'
}

-- Area da Quest, Cordenada Nort Esquerda ~ Sul Direita
local quest_range = {fromPos = Position(32200, 32040, 14), toPos = Position(32230, 32056, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
