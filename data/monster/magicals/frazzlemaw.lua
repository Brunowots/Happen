...
monster.loot = {
	...
	{name = "two handed sword", chance = 23200},
	{id = 3578, chance = 6750, maxCount = 3}, -- fish
	{name = "ham", chance = 6000, maxCount = 2},
	{name = "iron ore", chance = 13000},
	{name = "fish fin", chance = 14700},
	{name = "hardened bone", chance = 5000},
	{id = 5951, chance = 10800}, -- fish tail
	{name = "assassin dagger", chance = 1300},
	{name = "haunted blade", chance = 3240},
	{name = "nightmare blade", chance = 1100},
	{name = "great mana potion", chance = 25000, maxCount = 3},
	{name = "great health potion", chance = 25000, maxCount = 2},
	{name = "gold ingot", chance = 5300},
	{name = "sai", chance = 1460},
	{name = "violet crystal shard", chance = 3000},
	{name = "brown crystal splinter", chance = 6000},
	{name = "red crystal fragment", chance = 7600},
	{id = 16279, chance = 10000}, -- crystal rubbish
	{name = "cluster of solace", chance = 3450},
	{name = "frazzle tongue", chance = 8760},
	{name = "frazzle skin", chance = 6000}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -120, maxDamage = -400},
	-- bleed
	{name ="condition", type = CONDITION_BLEEDING, interval = 2000, chance = 10, minDamage = -200, maxDamage = -400, radius = 3, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -150, maxDamage = -500, length = 5, spread = 3, effect = CONST_ME_EXPLOSIONAREA, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -150, maxDamage = -300, radius = 2, shootEffect = CONST_ANI_LARGEROCK, effect = CONST_ME_STONES, target = true},
