...
const phmap::flat_hash_map<std::string, ItemParseAttributes_t> ItemParseAttributesMap = {
	...
	{ "spellboost", ITEM_PARSE_AUGMENTS },
...
class ItemParse : public Items {
	...
	protected:
		...
		static void parseAugments(const std::string &tmpStrValue, pugi::xml_node attributeNode, pugi::xml_attribute valueAttribute, ItemType &itemType);
