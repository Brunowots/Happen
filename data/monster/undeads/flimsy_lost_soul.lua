...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -400, maxDamage = -750},
	{name ="combat", interval = 1700, chance = 35, type = COMBAT_EARTHDAMAGE, minDamage = -450, maxDamage = -850, radius = 3, shootEffect = CONST_ANI_ENVENOMEDARROW, target = true},
	{name ="combat", interval = 1700, chance = 25, type = COMBAT_ENERGYDAMAGE, minDamage = -550, maxDamage = -750, length = 4, spread = 3, effect = CONST_ME_ENERGYHIT, target = false},
	{name ="combat", interval = 1700, chance = 35, type = COMBAT_DEATHDAMAGE, minDamage = -350, maxDamage = -850, radius = 3, effect = CONST_ME_MORTAREA, target = false}
}
