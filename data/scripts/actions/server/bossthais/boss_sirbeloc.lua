local config = {
  eventBoss = boss_sirbaeloc, -- Nome do evento
  bossAction = 63026, -- Action id que fica na alavanca
  storageQuest = 30070, -- Storage para tempo da quest
  ...
  exit_player = Position(33290, 32474, 9) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33424, 31413, 13), toPos = Position(33424, 31447, 13)},
    [2] = {fromPos = Position(33425, 31413, 13), toPos = Position(33424, 31447, 13)},
    [3] = {fromPos = Position(33426, 31413, 13), toPos = Position(33424, 31447, 13)},
    [4] = {fromPos = Position(33427, 31413, 13), toPos = Position(33424, 31447, 13)},
	[5] = {fromPos = Position(33428, 31413, 13), toPos = Position(33424, 31447, 13)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33425, 31433, 13), name = "Sir Baeloc"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33416, 31431, 13), toPos = Position(33434, 31450, 13)} -- Cordenada Nort Esquerda ~ Sul Direita
