local config = {
  eventBoss = boss_maxxenius, -- Nome do evento
  bossAction = 63038, -- Action id que fica na alavanca
...
local player_positions = { 
    [1] = {fromPos = Position(32214, 32021, 13), toPos = Position(32222, 32022, 14)},
    [2] = {fromPos = Position(32214, 32022, 13), toPos = Position(32222, 32022, 14)},
    [3] = {fromPos = Position(32214, 32023, 13), toPos = Position(32222, 32022, 14)},
    [4] = {fromPos = Position(32214, 32024, 13), toPos = Position(32222, 32022, 14)},
	[5] = {fromPos = Position(32214, 32025, 13), toPos = Position(32222, 32022, 14)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32199, 32018, 14), name = "Plagueroot"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(32196, 32014, 14), toPos = Position(32226, 32030, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
