local config = {
  eventBoss = boss_rotten, -- Nome do evento
  bossAction = 63002, -- Action id que fica na alavanca
  storageQuest = 30052, -- Storage para tempo da quest
  ...
  exit_player = Position(33779, 31598, 14) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33773, 31601, 14), toPos = Position(33743, 31604, 14)},
    [2] = {fromPos = Position(33774, 31601, 14), toPos = Position(33743, 31604, 14)},
    [3] = {fromPos = Position(33775, 31601, 14), toPos = Position(33743, 31604, 14)},
    [4] = {fromPos = Position(33776, 31601, 14), toPos = Position(33743, 31604, 14)},
	[5] = {fromPos = Position(33777, 31601, 14), toPos = Position(33743, 31604, 14)},
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33743, 31599, 14), name = "Goshnar's Hatred"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33734, 31590, 14), toPos = Position(33753, 31609, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
