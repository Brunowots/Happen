local config = {
  eventBoss = boss_brainhead, -- Nome do evento
  bossAction = 63010, -- Action id que fica na alavanca
  storageQuest = 30060, -- Storage para tempo da quest
  ...
  exit_player = Position(31972, 32324, 10) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(31971, 32324, 10), toPos = Position(31954, 32334, 10)},
    [2] = {fromPos = Position(31971, 32325, 10), toPos = Position(31954, 32334, 10)},
    [3] = {fromPos = Position(31971, 32326, 10), toPos = Position(31954, 32334, 10)},
    [4] = {fromPos = Position(31971, 32327, 10), toPos = Position(31954, 32334, 10)},
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(31954, 32325, 10), name = "Brain Head"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(31944, 32313, 10), toPos = Position(31966, 32336, 10)} -- Cordenada Nort Esquerda ~ Sul Direita
