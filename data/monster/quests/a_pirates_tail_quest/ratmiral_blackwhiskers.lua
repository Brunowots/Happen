...
monster.loot = {
	...
	{name = "Raccoon Backpack", chance = 800},	
	{name = "Scrubbing Brush", chance = 150},
	{name = "Soap", chance = 150}	
}

monster.attacks = {
	{name="melee" ,interval = 2000 ,minDamage = -500 ,maxDamage= -2550},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -500, maxDamage = -2500, range = 7, radius = 7, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true},
	{name ="combat", interval = 2000, chance = 18, type = COMBAT_PHYSICALDAMAGE, minDamage = -500, maxDamage = -1200, length = 4, spread = 3, effect = CONST_ME_GROUNDSHAKER, target = false},
	{name ="combat", interval = 2000, chance = 50, type = COMBAT_PHYSICALDAMAGE, minDamage = -400, maxDamage = -1550, range = 5, shootEffect = CONST_ANI_ROYALSPEAR, target = true},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -500, maxDamage = -1800, range = 5, shootEffect = CONST_ANI_BOLT, target = true}
}
