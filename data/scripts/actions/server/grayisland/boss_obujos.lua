local config = {
  eventBoss = boss_obujos, -- Nome do evento
  bossAction = 63047, -- Action id que fica na alavanca
  ...
  exit_player = Position(33438, 31247, 11) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33564, 31231, 11), toPos = Position(33429, 31255, 11)},
    [2] = {fromPos = Position(33565, 31231, 11), toPos = Position(33429, 31255, 11)},
    [3] = {fromPos = Position(33564, 31230, 11), toPos = Position(33429, 31255, 11)},
    [4] = {fromPos = Position(33565, 31230, 11), toPos = Position(33429, 31255, 11)},
	[5] = {fromPos = Position(33564, 31229, 11), toPos = Position(33429, 31255, 11)},
	[6] = {fromPos = Position(33565, 31229, 11), toPos = Position(33429, 31255, 11)},
	[7] = {fromPos = Position(33564, 31232, 11), toPos = Position(33429, 31255, 11)},
	[8] = {fromPos = Position(33565, 31232, 11), toPos = Position(33429, 31255, 11)},
	[9] = {fromPos = Position(33564, 31233, 11), toPos = Position(33429, 31255, 11)},
	[10] = {fromPos = Position(33565, 31233, 11), toPos = Position(33429, 31255, 11)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33437, 31267, 11), name = "Obujos"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33416, 31253, 11), toPos = Position(33447, 31275, 11)} -- Cordenada Nort Esquerda ~ Sul Direita
