...
monster.loot = {
	...
	{name = "lightning legs", chance = 10250},
	{name = "spellbook of warding", chance = 9350},
	{name = "ultimate health potion", chance = 10000, maxCount = 5},
	{name = "ultimate mana potion", chance = 10000, maxCount = 5},
	{name = "wand of starstorm", chance = 8300}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -450, maxDamage = -750},
	{name ="combat", interval = 1000, chance = 25, type = COMBAT_ENERGYDAMAGE, minDamage = -500, maxDamage = -1055, radius = 3, effect = CONST_ME_ENERGYAREA, target = false},
		{name ="combat", interval = 2000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -550, maxDamage = -975, radius = 3, effect = CONST_ME_HITBYENERGY, target = false}
}
