local config = {
	{name = "durable exercise sword", itemId = 35279, charges = 4000, storage = 998000},
	{name = "durable exercise axe", itemId = 35280, charges = 4000, storage = 998000},
	{name = "durable exercise club", itemId = 35281, charges = 4000, storage = 998000},
	{name = "durable exercise bow", itemId = 35282, charges = 4000, storage = 998000},
	{name = "durable exercise rod", itemId = 35283, charges = 4000, storage = 998000},
	{name = "durable exercise wand", itemId = 35284, charges = 4000, storage = 998000}
}
		...
		window:addChoice(string.format("%s", info.name), function (player, button, choice)
			...
			if inbox and inbox:getEmptySlots() > 0 then
				...
				if item then
					...
					player:sendTextMessage(MESSAGE_INFO_DESCR, "Congratulations, you just received a [".. info.name .."] and 15 Prey Wildcard.")
