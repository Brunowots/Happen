local config = {
  eventBoss = boss_thedreadmaiden, -- Nome do evento
  bossAction = 63007, -- Action id que fica na alavanca
  storageQuest = 30057, -- Storage para tempo da quest
  ...
  exit_player = Position(33747, 31502, 14) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33739, 31506, 14), toPos = Position(33711, 31509, 14)},
    [2] = {fromPos = Position(33740, 31506, 14), toPos = Position(33711, 31509, 14)},
    [3] = {fromPos = Position(33741, 31506, 14), toPos = Position(33711, 31509, 14)},
    [4] = {fromPos = Position(33742, 31506, 14), toPos = Position(33711, 31509, 14)},
	[5] = {fromPos = Position(33743, 31506, 14), toPos = Position(33711, 31509, 14)},
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33711, 31500, 14), name = "The Dread Maiden"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33702, 31494, 14), toPos = Position(33723, 31513, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
