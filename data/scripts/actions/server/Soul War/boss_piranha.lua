local config = {
  eventBoss = boss_piranha, -- Nome do evento
  bossAction = 63003, -- Action id que fica na alavanca
  storageQuest = 30053, -- Storage para tempo da quest
  ...
  exit_player = Position(33781, 31630, 14) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33774, 31634, 14), toPos = Position(33743, 31638, 14)},
    [2] = {fromPos = Position(33775, 31634, 14), toPos = Position(33743, 31638, 14)},
    [3] = {fromPos = Position(33776, 31634, 14), toPos = Position(33743, 31638, 14)},
    [4] = {fromPos = Position(33777, 31634, 14), toPos = Position(33743, 31638, 14)},
	[5] = {fromPos = Position(33778, 31634, 14), toPos = Position(33743, 31638, 14)},
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33743, 31628, 14), name = "Goshnar's Spite"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33733, 31623, 14), toPos = Position(33752, 31642, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
