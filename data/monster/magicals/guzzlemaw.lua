...
monster.loot = {
	...
	{name = "assassin dagger", chance = 1200},
	{name = "haunted blade", chance = 4000},
	{name = "nightmare blade", chance = 1380},
	{name = "great mana potion", chance = 27000, maxCount = 3},
	{name = "great health potion", chance = 28500, maxCount = 2},
	{name = "sai", chance = 3000},
	{name = "violet crystal shard", chance = 3000},
	{name = "brown crystal splinter", chance = 4000, maxCount = 2},
	{name = "red crystal fragment", chance = 5600},
	{id = 16279, chance = 12000}, -- crystal rubbish
	{name = "cluster of solace", chance = 3200},
	{name = "frazzle tongue", chance = 7500},
	{name = "frazzle skin", chance = 7000}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -200, maxDamage = -450},
	-- bleed
	{name ="condition", type = CONDITION_BLEEDING, interval = 2000, chance = 10, minDamage = -300, maxDamage = -800, radius = 3, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -200, maxDamage = -650, length = 8, spread = 3, effect = CONST_ME_EXPLOSIONAREA, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -150, maxDamage = -500, radius = 2, shootEffect = CONST_ANI_LARGEROCK, effect = CONST_ME_STONES, target = true},
	{name ="speed", interval = 2000, chance = 15, speedChange = -800, radius = 6, effect = CONST_ME_MAGIC_RED, target = false, duration = 15000},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -100, maxDamage = -800, length = 8, spread = 3, effect = CONST_ME_MAGIC_RED, target = false}
}
