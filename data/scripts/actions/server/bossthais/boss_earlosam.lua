local config = {
  eventBoss = boss_earlosam, -- Nome do evento
  bossAction = 63024, -- Action id que fica na alavanca
  storageQuest = 30068, -- Storage para tempo da quest
  ...
  exit_player = Position(33261, 31986, 8) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33516, 31444, 13), toPos = Position(33489, 31441, 13)},
    [2] = {fromPos = Position(33517, 31444, 13), toPos = Position(33489, 31441, 13)},
    [3] = {fromPos = Position(33518, 31444, 13), toPos = Position(33489, 31441, 13)},
    [4] = {fromPos = Position(33519, 31444, 13), toPos = Position(33489, 31441, 13)},
	[5] = {fromPos = Position(33520, 31444, 13), toPos = Position(33489, 31441, 13)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33488, 31435, 13), name = "Earl Osam"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33479, 31429, 13), toPos = Position(33497, 31448, 13)} -- Cordenada Nort Esquerda ~ Sul Direita
