...
monster.loot = {
	...
	{id = 23501, chance = 19900}, -- condensed energy
	{id = 23524, chance = 18300}, -- small energy ball
	{id = 23506, chance = 18000}, -- plasma pearls
	{id = 16126, chance = 13400}, -- red crystal fragment
	{id = 16120, chance = 13400}, -- violet crystal shard
	{id = 16124, chance = 12700, maxCount = 2}, -- blue crystal splinter
	{id = 16119, chance = 10900}, -- blue crystal shard
	{id = 3039, chance = 8500}, -- red gem
	{id = 8092, chance = 6100} -- wand of starstorm
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -250, maxDamage = -500},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -280, maxDamage = -400, range = 5, radius = 5, shootEffect = CONST_ANI_ENERGYBALL, effect = CONST_ME_PURPLEENERGY, target = true},
	{name ="reality reaver wave", interval = 2000, chance = 20, minDamage = -400, maxDamage = -550, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -180, maxDamage = -300, radius = 3, effect = CONST_ME_STUN, target = false}
}
