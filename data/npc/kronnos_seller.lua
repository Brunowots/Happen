local internalNpcName = "Kronnos Seller"
...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "trade") then
		...
		npcHandler:say("Se você tiver algum token de ouro com você, vamos dar uma olhada! Estas são as minhas ofertas.", npc, creature)
