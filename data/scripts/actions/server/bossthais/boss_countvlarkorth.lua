local config = {
  eventBoss = boss_countvlarkorth, -- Nome do evento
  bossAction = 63025, -- Action id que fica na alavanca
  storageQuest = 30069, -- Storage para tempo da quest
  ...
  exit_player = Position(33195, 31690, 8) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33455, 31413, 13), toPos = Position(33457, 31442, 13)},
    [2] = {fromPos = Position(33456, 31413, 13), toPos = Position(33457, 31442, 13)},
    [3] = {fromPos = Position(33457, 31413, 13), toPos = Position(33457, 31442, 13)},
    [4] = {fromPos = Position(33458, 31413, 13), toPos = Position(33457, 31442, 13)},
	[5] = {fromPos = Position(33459, 31413, 13), toPos = Position(33457, 31442, 13)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33456, 31433, 13), name = "Count Vlarkorth"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33448, 31428, 13), toPos = Position(33465, 31447, 13)} -- Cordenada Nort Esquerda ~ Sul Direita
