...
monster.loot = {
	...
	{id = 6299, chance = 10260}, -- death ring
	{id = 6499, chance = 3330}, -- demonic essence
	{id = 8043, chance = 4220}, -- focus cape
	{id = 21974, chance = 10500}, -- golden lotus brooch
	{id = 826, chance = 1000}, -- magma coat
	{id = 3078, chance = 10400}, -- mysterious fetish
	{id = 3574, chance = 10300}, -- mystic turban
	{id = 21981, chance = 1000}, -- oriental shoes
	{id = 21975, chance = 8000}, -- peacock feather fan
	{id = 5911, chance = 1000}, -- red piece of cloth
	{id = 3016, chance = 1000}, -- ruby necklace
	{id = 5944, chance = 3000}, -- soul orb
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -50, maxDamage = -280, length = 8, spread = 3, effect = CONST_ME_PURPLEENERGY, target = false},
	{name ="energy strike", interval = 2000, chance = 10, minDamage = -100, maxDamage = -280, range = 1, target = false},
