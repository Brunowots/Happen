local config = {
  eventBoss = boss_thepaleworm, -- Nome do evento
  bossAction = 63009, -- Action id que fica na alavanca
  storageQuest = 30059, -- Storage para tempo da quest
  ...
  exit_player = Position(33781, 31500, 14) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33772, 31504, 14), toPos = Position(33809, 31513, 14)},
    [2] = {fromPos = Position(33773, 31504, 14), toPos = Position(33809, 31513, 14)},
    [3] = {fromPos = Position(33774, 31504, 14), toPos = Position(33809, 31513, 14)},
    [4] = {fromPos = Position(33775, 31504, 14), toPos = Position(33809, 31513, 14)},
	[5] = {fromPos = Position(33772, 31504, 14), toPos = Position(33809, 31513, 14)},
	[6] = {fromPos = Position(33773, 31503, 14), toPos = Position(33809, 31513, 14)},
	[7] = {fromPos = Position(33774, 31504, 14), toPos = Position(33809, 31513, 14)},
	[8] = {fromPos = Position(33773, 31505, 14), toPos = Position(33809, 31513, 14)},
	[9] = {fromPos = Position(33774, 31505, 14), toPos = Position(33809, 31513, 14)},
	[10] = {fromPos = Position(33775, 31505, 14), toPos = Position(33809, 31513, 14)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33805, 31500, 14), name = "The Pale Worm"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33794, 31495, 14), toPos = Position(33818, 31516, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
