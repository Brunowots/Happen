local config = {
  eventBoss = boss_mazzinor, -- Nome do evento
  bossAction = 63031, -- Action id que fica na alavanca
  storageQuest = 30075, -- Storage para tempo da quest
  ...
  exit_player = Position(32721, 32769, 10) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(32721, 32773, 10), toPos = Position(32724, 32726, 10)},
    [2] = {fromPos = Position(32722, 32773, 10), toPos = Position(32724, 32726, 10)},
    [3] = {fromPos = Position(32723, 32773, 10), toPos = Position(32724, 32726, 10)},
    [4] = {fromPos = Position(32724, 32773, 10), toPos = Position(32724, 32726, 10)},
	[5] = {fromPos = Position(32725, 32773, 10), toPos = Position(32724, 32726, 10)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32724, 32716, 10), name = "Mazzinor"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(32715, 32713, 10), toPos = Position(32733, 32729, 10)} -- Cordenada Nort Esquerda ~ Sul Direita
