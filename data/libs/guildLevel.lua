...
CONFIG_GUILD_LEVEL = {
	quantityToLevel = 5000, -- points to next level
	...
	rewards = {-- level, type of the reward and bonus quantity
		...
		[2] = {level = 2, type = GUILD_LEVEL_BONUS_EXP, quantity = 0.02},
		[3] = {level = 3, type = GUILD_LEVEL_BONUS_LOOT, quantity = 0.02},
		[4] = {level = 4, type = GUILD_LEVEL_BONUS_EXP, quantity = 0.05},
		[5] = {level = 5, type = GUILD_LEVEL_BONUS_LOOT, quantity = 0.05},
		[6] = {level = 6, type = GUILD_LEVEL_BONUS_EXP, quantity = 0.08},
		[7] = {level = 7, type = GUILD_LEVEL_BONUS_LOOT, quantity = 0.08},
		[8] = {level = 8, type = GUILD_LEVEL_BONUS_EXP, quantity = 0.10},
		[9] = {level = 9, type = GUILD_LEVEL_BONUS_LOOT, quantity = 0.10},
		[10] = {level = 10, type = GUILD_LEVEL_BONUS_ELEMENTAL, quantity = 0.6}
	}
}
...
CONFIG_GUILD_MONSTERS = {
	...
	killingPlayer = {level = 500, pts = 5, msg = "The player %s killed someone above level 500 and earned %d points for your guild!"}
}
