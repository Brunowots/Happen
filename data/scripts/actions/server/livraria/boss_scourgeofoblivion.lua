local config = {
  eventBoss = boss_thescourgeofoblivion, -- Nome do evento
  bossAction = 63034, -- Action id que fica na alavanca
  storageQuest = 30077, -- Storage para tempo da quest
  ...
  exit_player = Position(32676, 32737, 11) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(32676, 32743, 11), toPos = Position(32726, 32746, 11)},
    [2] = {fromPos = Position(32677, 32743, 11), toPos = Position(32726, 32746, 11)},
    [3] = {fromPos = Position(32676, 32742, 11), toPos = Position(32726, 32746, 11)},
    [4] = {fromPos = Position(32677, 32742, 11), toPos = Position(32726, 32746, 11)},
	[5] = {fromPos = Position(32676, 32741, 11), toPos = Position(32726, 32746, 11)},
	[6] = {fromPos = Position(32677, 32741, 11), toPos = Position(32726, 32746, 11)},
	[7] = {fromPos = Position(32676, 32744, 11), toPos = Position(32726, 32746, 11)},
	[8] = {fromPos = Position(32677, 32744, 11), toPos = Position(32726, 32746, 11)},
	[9] = {fromPos = Position(32676, 32745, 11), toPos = Position(32726, 32746, 11)},
	[10] = {fromPos = Position(32677, 32745, 11), toPos = Position(32726, 32746, 11)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32726, 32736, 11), name = "The Scourge Of Oblivion"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(32712, 32722, 11), toPos = Position(32738, 32749, 11)} -- Cordenada Nort Esquerda ~ Sul Direita
