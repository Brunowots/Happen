local config = {
  eventBoss = boss_kingzelos, -- Nome do evento
  bossAction = 63021, -- Action id que fica na alavanca
  storageQuest = 30065, -- Storage para tempo da quest
  ...
  level_req = 350, -- Level Requerido
  min_players = 1, -- Minimo de Jogadores
  exit_player = Position(33494, 31544, 13) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33485, 31546, 13), toPos = Position(33443, 31539, 13)},
    [2] = {fromPos = Position(33485, 31544, 13), toPos = Position(33443, 31539, 13)},
    [3] = {fromPos = Position(33485, 31545, 13), toPos = Position(33443, 31539, 13)},
    [4] = {fromPos = Position(33485, 31547, 13), toPos = Position(33443, 31539, 13)},
	[5] = {fromPos = Position(33485, 31548, 13), toPos = Position(33443, 31539, 13)},
	[6] = {fromPos = Position(33486, 31546, 13), toPos = Position(33443, 31539, 13)},
	[7] = {fromPos = Position(33486, 31544, 13), toPos = Position(33443, 31539, 13)},
	[8] = {fromPos = Position(33486, 31545, 13), toPos = Position(33443, 31539, 13)},
	[9] = {fromPos = Position(33486, 31547, 13), toPos = Position(33443, 31539, 13)},
	[10] = {fromPos = Position(33486, 31548, 13), toPos = Position(33443, 31539, 13)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33443, 31550, 13), name = "King Zelos"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33432, 31535, 13), toPos = Position(33454, 31557, 13)} -- Cordenada Nort Esquerda ~ Sul Direita
