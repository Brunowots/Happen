local config = {
  eventBoss = boss_lordazaram, -- Nome do evento
  bossAction = 63023, -- Action id que fica na alavanca
  storageQuest = 30067, -- Storage para tempo da quest
  ...
  exit_player = Position(32192, 31819, 8) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33422, 31493, 13), toPos = Position(33425, 31480, 13)},
    [2] = {fromPos = Position(33423, 31493, 13), toPos = Position(33425, 31480, 13)},
    [3] = {fromPos = Position(33424, 31493, 13), toPos = Position(33425, 31480, 13)},
    [4] = {fromPos = Position(33425, 31493, 13), toPos = Position(33425, 31480, 13)},
	[5] = {fromPos = Position(33426, 31493, 13), toPos = Position(33425, 31480, 13)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33425, 31467, 13), name = "Lord Azaram"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33416, 31463, 13), toPos = Position(33433, 31482, 13)} -- Cordenada Nort Esquerda ~ Sul Direita
