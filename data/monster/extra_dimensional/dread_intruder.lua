...
monster.loot = {
	...
	{id = 23510, chance = 19600}, -- odd organ
	{id = 16124, chance = 19500}, -- blue crystal splinter
	{id = 16125, chance = 16200}, -- cyan crystal fragment
	{id = 3030, chance = 25400, maxCount = 2}, -- small ruby
	{id = 3029, chance = 25400, maxCount = 2}, -- small sapphire
	{id = 3033, chance = 25000, maxCount = 2}, -- small amethyst
	{id = 16120, chance = 14500}, -- violet crystal shard
	{id = 3036, chance = 10000}, -- violet gem
	{id = 23533, chance = 4450}, -- ring of red plasma
	{id = 23542, chance = 4230}, -- collar of blue plasma
	{id = 23543, chance = 4230}, -- collar of green plasma
	{id = 23529, chance = 4230} -- ring of blue plasma
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -400, maxDamage = -500},
	-- energy damage
	{name ="condition", type = CONDITION_ENERGY, interval = 2000, chance = 20, minDamage = -400, maxDamage = -700, radius = 5, effect = CONST_ME_ENERGYHIT, target = false},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_DEATHDAMAGE, minDamage = -250, maxDamage = -500, range = 4, radius = 4, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},
