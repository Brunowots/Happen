...
monster.loot = {
	...
	{name = "serpent sword", chance = 8420},
	{name = "violet crystal shard", chance = 2420},
	{name = "green gem", chance = 3610},
	{name = "onyx chip", chance = 1610, maxCount = 3}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -150, maxDamage = -480},
	{name ="explosion wave", interval = 2000, chance = 15, minDamage = -280, maxDamage = -500, target = false},
