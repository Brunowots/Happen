local config = {
  ...
  bossAction = 63039, -- Action id que fica na alavanca
...
local player_positions = { 
    [1] = {fromPos = Position(32210, 32021, 13), toPos = Position(32222, 32002, 14)},
    [2] = {fromPos = Position(32210, 32022, 13), toPos = Position(32222, 32002, 14)},
    [3] = {fromPos = Position(32210, 32023, 13), toPos = Position(32222, 32002, 14)},
    [4] = {fromPos = Position(32210, 32024, 13), toPos = Position(32222, 32002, 14)},
	[5] = {fromPos = Position(32210, 32025, 13), toPos = Position(32222, 32002, 14)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(32199, 31997, 14), name = "Maxxenius"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(32195, 31993, 14), toPos = Position(32226, 32010, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
