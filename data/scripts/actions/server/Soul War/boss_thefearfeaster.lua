local config = {
  eventBoss = boss_thefearfeaster, -- Nome do evento
  bossAction = 63008, -- Action id que fica na alavanca
  storageQuest = 30058, -- Storage para tempo da quest
  ...
  exit_player = Position(33742, 31467, 14) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33734, 31471, 14), toPos = Position(33712, 31474, 14)},
    [2] = {fromPos = Position(33735, 31471, 14), toPos = Position(33712, 31474, 14)},
    [3] = {fromPos = Position(33736, 31471, 14), toPos = Position(33712, 31474, 14)},
    [4] = {fromPos = Position(33737, 31471, 14), toPos = Position(33712, 31474, 14)},
	[5] = {fromPos = Position(33738, 31471, 14), toPos = Position(33712, 31474, 14)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33712, 31465, 14), name = "The Fear Feaster"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33702, 31461, 14), toPos = Position(33719, 31478, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
