...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "blessing") or MsgContains(message, "bless") then
			npcHandler:say("Do you want to receive the blessing of the inquisition - which means ".. (missing == 5 and "all seven available" or missing ) .." blessings - for " .. totalBlessPrice .. " gold?", npc, creature)
	...
	elseif MsgContains(message, "yes") then
		...
		elseif npcHandler:getTopic(playerId) == 7 then
			...
			elseif player:removeMoneyBank(totalBlessPrice) then
				npcHandler:say("You have been blessed by all of seven gods!, |PLAYERNAME|.", npc, creature)
