local config = {
  eventBoss = boss_tentugly, -- Nome do evento
  bossAction = 63030, -- Action id que fica na alavanca
  storageQuest = 30074, -- Storage para tempo da quest
  ...
  exit_player = Position(33800, 31357, 7) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33792, 31391, 6), toPos = Position(33722, 31187, 6)},
    [2] = {fromPos = Position(33793, 31391, 6), toPos = Position(33722, 31187, 6)},
    [3] = {fromPos = Position(33794, 31391, 6), toPos = Position(33722, 31187, 6)},
    [4] = {fromPos = Position(33795, 31391, 6), toPos = Position(33722, 31187, 6)},
	[5] = {fromPos = Position(33796, 31391, 6), toPos = Position(33722, 31187, 6)},
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33722, 31182, 7), name = "Tentuglys Head"} -- Posi??o do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33703, 31175, 7), toPos = Position(33737, 31191, 7)} -- Cordenada Nort Esquerda ~ Sul Direita
