...
GameStore.Categories = {
{
	...
	},
	{
		...
		offers = {
		
		    {
				...
				name = "Smoke Magic Wall Rune",
				price = 200,
				itemtype = 44078,
				count = 1,
				description = "<i>Ao dar 'use' no item voce adiciona uma nova skin da sua magic Wall, para escolher a skin desejada digite o comando !mwcolor.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Magic_Wall_Rune.png" },
				name = "Purple Magic Wall Rune",
				price = 200,
				itemtype = 44079,
				count = 1,
				description = "<i>Ao dar 'use' no item voce adiciona uma nova skin da sua magic Wall, para escolher a skin desejada digite o comando !mwcolor.",
			...
			},
			{
				...
				{
				icons = { "Magic_Wall_Rune.png" },
				name = "Miami Blue Magic Wall Rune",
				price = 200,
				itemtype = 44083,
				count = 1,
				description = "<i>Ao dar 'use' no item voce adiciona uma nova skin da sua magic Wall, para escolher a skin desejada digite o comando !mwcolor.",
	...
	},
	{
		...
		name = "Happen Store",
		rookgaard = true,
		subclasses = {"Items", "Drome Potions"},
		state = GameStore.States.STATE_NEW,
	},	
    {
		...
		offers = {
			{
				...
				itemtype = 44095,
				count = 1,
				description = "<i>Capacidade 30, slot 1",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
		
			{
				icons = { "44097.gif" },
				name = "Skelet backpack",
				price = 850,
				itemtype = 44097,
				count = 1,
				description = "<i>Capacidade 30, slot 1",
			...
			},
			{
				...
				itemtype = 10227,
				count = 1,
				description = "<i>Protection all +5%.\nDistance, axe, sword, club +3.\nMagic Level +1\nLife Leech +5% (chance 100%).\nSpeed +20.\nOnly for Knights and Paladins",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "34326.gif" },
				...
				itemtype = 34326,
				count = 1,
				description = "<i>Protection all +5%.\nMagic Level +5.\nMana Leech +5% (chance 100%).\nSpeed +20.\nOnly for Sorcerers and druids",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "35909.gif" },
				name = "Happen Teleport",
				price = 320,
				itemtype = 35909,
				count = 1,
				description = "<i>Pedra de teleport, para tornar sua experiencia mais dinamica. Cooldown de 30 segundos por uso.\nViaje para as principais cidades e pontos estrategicos",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "16262.gif" },
				...
				itemtype = 16262,
				count = 1,
				description = "<i>Invoque um npc para refilar sem ter que voltar para cidade.\nSomente para Vips.\nTem que estar sem battle para usar.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "44096.gif" },
				name = "Happen Loot Pouch",
				price = 500,
				itemtype = 44096,
				count = 1,
			...
			{
                icons = { "44093.png" },
          			name = "Roleta Mega Token",
         			price = 1100,
          			itemtype = 44093,
          			count = 5,
          			description = "<i>Com esse token você consegue girar a roleta mega.",
          			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
           	},
			{
				icons = { "44094.gif" },
				name = "Roleta Super Token",
				price = 700,
				itemtype = 44094,
				count = 1,
				description = "<i>Com esse token você consegue girar a roleta super",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "44092.gif" },
				...
				itemtype = 44092,
				count = 1,
				description = "<i>Com esse token você consegue girar a roleta sanguine",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				home = true,
			},
			{
                icons = { "22720.png" },
          			name = "Charm Points Token",
         			price = 250,
          			itemtype = 22720,
          			count = 1,
          			description = "<i>ganhar 500charms points.",
			...
			},
			{
                icons = { "22118.png" },
         		...
         		price = 115,
          		itemtype = 22118,
          		count = 1,
          		description = "<i>Use para receber 100 tibia coins.",
          		type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
            },
		},
	},
	{
		...
		{
		   {
				icons = { "1Charm_Upgrade.gif" },
				name = "Charm Upgrade Potion",
				price = 25,
                itemtype = 36726,
				count = 1,
            ...
            {
				icons = { "2Bestiary_Betterment.gif" },
				name = "Bestiary betterment Potion",
				price = 25,
                itemtype = 36728,
				count = 1,
            ...
            {
				icons = { "3Death_Amplification.gif" },
				name = "Death Amplification Potion",
				price = 25,
                itemtype = 36741,
				count = 1,
				description = "Drinking this potion temporarily amplifies death damage against monsters.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "4Death_Resilience.gif" },
				name = "Death Resilience Potion",
				price = 25,
                itemtype = 36734,
				count = 1,
				description = "Drinking this potion temporarily increases death protection.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "5Earth_Amplification.gif" },
				name = "Earth Amplification Potion",
				price = 25,
                itemtype = 36738,
				count = 1,
				description = "Drinking this potion temporarily amplifies earth damage against monsters.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "6Earth_Resilience.gif" },
				name = "Earth Resilience Potion",
				price = 25,
                itemtype = 36731,
				count = 1,
				description = "Drinking this potion temporarily increases earth protection.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "7Energy_Amplification.gif" },
				name = "Energy Amplification Potion",
				price = 25,
                itemtype = 36739,
				count = 1,
				description = "Drinking this potion temporarily amplifies energy damage against monsters.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "8Energy_Resilience.gif" },
				name = "Energy Resilience Potion",
				price = 25,
                itemtype = 36732,
				count = 1,
				description = "Drinking this potion temporarily increases energy protection.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "9Fire_Amplification.gif" },
				name = "Fire Amplification Potion",
				price = 25,
                itemtype = 36736,
				count = 1,
				description = "Drinking this potion temporarily amplifies fire damage against monsters.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "10Fire_Resilience.gif" },
				name = "Fire Resilience Potion",
				price = 25,
                itemtype = 36729,
				count = 1,
				description = "Drinking this potion temporarily increases fire protection.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "11Holy_Amplification.gif" },
				name = "Holy Amplification Potion",
				price = 25,
                itemtype = 36740,
				count = 1,
				description = "Drinking this potion temporarily amplifies holy damage against monsters.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "12Holy_Resilience.gif" },
				name = "Holy Resilience Potion",
				price = 25,
                itemtype = 36733,
				count = 1,
				description = "Drinking this potion temporarily increases holy protection.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "13Ice_Amplification.gif" },
				name = "Ice Amplification Potion",
				price = 25,
                itemtype = 36737,
				count = 1,
				description = "Drinking this potion temporarily amplifies ice damage against monsters.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "14Ice_Resilience.gif" },
				name = "Ice Resilience Potion",
				price = 25,
                itemtype = 36730,
				count = 1,
				description = "Drinking this potion temporarily increases ice protection.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "15Kooldown-Aid.gif" },
				name = "Kooldown Aid Potion",
				price = 25,
                itemtype = 36723,
				count = 1,
            ...
            {
				icons = { "16Physical_Amplification.gif" },
				name = "Physical Amplification Potion",
				price = 25,
                itemtype = 36742,
				count = 1,
				description = "Drinking this potion temporarily amplifies physical damage against monsters.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "17Physical_Resilience.gif" },
				name = "Physical Resilience Potion",
				price = 25,
                itemtype = 36735,
				count = 1,
				description = "Drinking this potion temporarily increases physical protection.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
				icons = { "18Strike_Enhancement.gif" },
				name = "Strike Enhancement Potion",
				price = 25,
                itemtype = 36724,
				count = 1,
            ...
            {
				icons = { "19Wealth_Duplex.gif" },
				name = "Wealth Duplex Potion",
				price = 25,
                itemtype = 36727,
				count = 1,
            ...
            {
				icons = { "20Stamina_Extension.gif" },
				name = "Stamina Extension Potion",
				price = 25,
                itemtype = 36725,
				count = 1,
	...
	-- beds
	{
		...
		{
					icons = { "Bone_Bed.png" },
					name = "Bone Headboard Bed",
					price = 200,
					itemtype = 32795, -- pillow id
					-- itemtype = {40718, 40719},          
					count = 1,
					description = "{house}\n{box}\n{storeinbox}\n{use}\n{backtoinbox}",
					type = GameStore.OfferTypes.OFFER_TYPE_HOUSE_BED, 
		...
		{
					icons = { "Opulent_Kline_Bed.png" },
					name = "Opulent kline Bed",
					price = 200,
					itemtype = 42359, -- pillow id
					-- itemtype = {40718, 40719},          
					count = 1,
					description = "{house}\n{box}\n{storeinbox}\n{use}\n{backtoinbox}",
					type = GameStore.OfferTypes.OFFER_TYPE_HOUSE_BED, 
		...
		{
					icons = { "Seafarerg_Bed.png" },
					name = "Seafarer Bed",
					price = 200,
					itemtype = 42287, -- pillow id
					-- itemtype = {40718, 40719},          
					count = 1,
					description = "{house}\n{box}\n{storeinbox}\n{use}\n{backtoinbox}",
					type = GameStore.OfferTypes.OFFER_TYPE_HOUSE_BED, 
