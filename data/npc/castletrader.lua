...
local function onTradeRequest(npc, creature)
	...
	if player:getLevel() < 100 then
		npcHandler:say('Ops, somente nivel 100+', npc, creature)
		return false
	end
...
npcHandler:setMessage(MESSAGE_GREET, "<Sighs> Bem Vindo, |PLAYERNAME|! Parabens por dominar o castelo, agora voce pode vender seus equipamentos com mais facilidade.")
npcHandler:setMessage(MESSAGE_FAREWELL, "Ate mais, |PLAYERNAME|. Boa sorte na proxima batalha!")
npcHandler:setMessage(MESSAGE_WALKAWAY, "Cuidado, o castelo abre todos os dias as 19:00, sua guild vai conseguir mante-lo?.")
npcHandler:setMessage(MESSAGE_SENDTRADE, 'Aproveite, grande guerreiro!')
