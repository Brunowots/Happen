...
class PlayerFunctions final : LuaScriptInterface {
	private:
		static void init(lua_State* L) {
			...
			registerMethod(L, "Player", "resetSpellsCooldown", PlayerFunctions::luaPlayerResetSpellsCooldown);
			...
			registerMethod(L, "Player", "getSpellCooldownModifier", PlayerFunctions::luaPlayerGetSpellCooldownModifier);
			registerMethod(L, "Player", "getSpellSkillModifier", PlayerFunctions::luaPlayerGetSpellSkillModifier);
			registerMethod(L, "Player", "getSpellImpactModifier", PlayerFunctions::luaPlayerGetSpellImpactModifier);
		...
		static int luaPlayerGetSpellCooldownModifier(lua_State* L);
		static int luaPlayerGetSpellSkillModifier(lua_State* L);
		static int luaPlayerGetSpellImpactModifier(lua_State* L);
