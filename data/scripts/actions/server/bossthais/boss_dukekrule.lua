local config = {
  eventBoss = boss_dukekrule, -- Nome do evento
  bossAction = 63022, -- Action id que fica na alavanca
  storageQuest = 30066, -- Storage para tempo da quest
  ...
  exit_player = Position(32347, 32167, 12) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33455, 31493, 13), toPos = Position(33456, 31477, 13)},
    [2] = {fromPos = Position(33456, 31493, 13), toPos = Position(33456, 31477, 13)},
    [3] = {fromPos = Position(33457, 31493, 13), toPos = Position(33456, 31477, 13)},
    [4] = {fromPos = Position(33458, 31493, 13), toPos = Position(33456, 31477, 13)},
	[5] = {fromPos = Position(33459, 31493, 13), toPos = Position(33456, 31477, 13)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33456, 31468, 13), name = "Duke Krule"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33447, 31463, 13), toPos = Position(33465, 31483, 13)} -- Cordenada Nort Esquerda ~ Sul Direita
