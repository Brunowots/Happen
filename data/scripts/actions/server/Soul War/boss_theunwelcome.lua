local config = {
  eventBoss = boss_theunwelcome, -- Nome do evento
  bossAction = 63006, -- Action id que fica na alavanca
  storageQuest = 30056, -- Storage para tempo da quest
  ...
  exit_player = Position(33745, 31534, 14) -- Para onde o player vai quando acabar o tempo do boss
}

-- Position dos Players
local player_positions = { 
    [1] = {fromPos = Position(33736, 31537, 14), toPos = Position(33709, 31545, 14)},
    [2] = {fromPos = Position(33737, 31537, 14), toPos = Position(33709, 31545, 14)},
    [3] = {fromPos = Position(33738, 31537, 14), toPos = Position(33709, 31545, 14)},
    [4] = {fromPos = Position(33739, 31537, 14), toPos = Position(33709, 31545, 14)},
	[5] = {fromPos = Position(33740, 31537, 14), toPos = Position(33709, 31545, 14)}
}

-- Position dos monstros
local monsters = {
    [1] = {pos = Position(33709, 31534, 14), name = "The Unwelcome"} -- Posição do 'BOSS'
}

-- Area da Quest
local quest_range = {fromPos = Position(33698, 31529, 14), toPos = Position(33720, 31549, 14)} -- Cordenada Nort Esquerda ~ Sul Direita
